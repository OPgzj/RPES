...
try:
    import utils.loggers.clearml
    from utils.loggers.clearml import Dataset, Task

    assert hasattr(utils.loggers.clearml, '__version__')  # verify package import not local dir
