...
def bbox_iou(box1, box2, xywh=True, GIoU=False, SIoU=False, DIoU=False, CIoU=False, MDPIoU=False, Inner=False, Focaleriou=False, ratio=0.7, feat_h=640, 
    ...
    if CIoU or DIoU or GIoU:
        ...
        adjusted_iou = iou - 0.5 * (distance_cost + shape_cost)
        return adjusted_iou
    elif MDPIoU:
