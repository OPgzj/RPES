from PySide6.QtWidgets import QApplication, QMainWindow, QProgressDialog, QMessageBox, QSplitter, QTableWidgetItem, QScrollArea, QTableWidget, QLineEdit, QGraphicsPixmapItem, QFileDialog, QPushButton, QGraphicsView, QGraphicsScene, QHBoxLayout, QToolBox, QLabel, QVBoxLayout, QWidget
...
from yologui.yolo.yolov9.detect_dual import Detector
...
class CrackDetectWindow(QMainWindow): 
    ...
    def setupUi(self):
        ...
        self.page2FolderPathLineEdit = QLineEdit('yologuiMy_Work_Place/test_img/30imgtest')
