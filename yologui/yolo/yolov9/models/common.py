...
from yologui.yolo.yolov9.utils import TryExcept
from yologui.yolo.yolov9.utils.dataloaders import exif_transpose, letterbox
from yologui.yolo.yolov9.utils.general import (LOGGER, ROOT, Profile, check_requirements, check_suffix, check_version, colorstr,
...
from yologui.yolo.yolov9.utils.torch_utils import copy_attr, smart_inference_mode
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights='yolo.pt', device=torch.device('cpu'), dnn=False, data=None, fp16=False, fuse=True):
        ...
        from yologui.yolo.yolov9.models.experimental import attempt_download, attempt_load  # scoped to avoid circular import
        ...
        if pt:  # PyTorch
            ...
            from yologui.yolo.yolov9.utils.triton import TritonRemoteModel
    ...
    def _model_type(p='path/to/model.pt'):
        ...
        from yologui.yolo.yolov9.export import export_formats
        from yologui.yolo.yolov9.utils.downloads import is_url
...
class AutoShape(nn.Module):
    ...
    def _apply(self, fn):
        ...
        from yologui.yolo.yolov9.models.yolo import Detect, Segment
        if self.pt:
            m = self.model.model.model[-1] if self.dmb else self.model.model[-1]  # Detect()
